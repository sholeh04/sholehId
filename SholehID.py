...
╚═════╝░╚═╝░░╚═╝░╚════╝░╚══════╝╚══════╝╚═╝░░╚═╝
\033[1;94m──────────────────────────────────────────
\033[1;95m{\033[1;96m×\033[1;95m} \033[1;93mAuthor   \033[1;91m: \033[1;96mCyber Probolinggo
...
def masuk():
	...
	print "\033[1;97m{\033[1;92m02\033[1;97m} Cara Ambil Token"
	print "\033[1;97m{\033[1;91m00\033[1;97m} Keluar"
	print 50* "\033[1;94m─"
	pilih_masuk()

def pilih_masuk():
	msuk = raw_input("\033[1;92m︻テייייי一一 \033[91m:\033[1;92m ")
	if msuk =="":
...
def tokenz():
	...
	try:
		...
		jalan ('\033[1;97mJANGAN LUPA FOLLOW FACEBOOK SAYA YA :)')
...
def ambil_token():
	...
	os.system('xdg-4 https://drive.google.com/file/d/1eAuQG4aFIH49r0ACpoUWspnSG2VUl4Ci/view?usp=drivesdk')
	time.sleep(2)
	masuk()
...
##### MAIN BANGLADESH #####
	def main(arg):
		sys.stdout.write("\r{}".format(datetime.now().strftime("\033[1;96m%H\033[1;91m:\033[1;93m%M\033[1;91m:\033[1;96m%Y\033[1;97m: \033[1;92m%S")));sys.stdout.flush()
		global cekpoint,oks
		zowe = arg
		try:
			os.mkdir('done')
